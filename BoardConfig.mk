...
DEVICE_PATH := device/ulefone/Armor_3WT
...
# Assert
TARGET_OTA_ASSERT_DEVICE := Armor_3WT
...
TARGET_KERNEL_SOURCE := kernel/ulefone/Armor_3WT
TARGET_KERNEL_CONFIG := Armor_3WT_defconfig
